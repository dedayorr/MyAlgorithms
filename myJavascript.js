...
//   makeHTTPRequest('http://example.com', handleResponse);

// function callback(n){
//     return n**2
// }

// function cube(callbacks, n){
//     return callback(n)*n
// }
...
// setTimeout(sayhello, 60000)


// const digits = [2,4,5,6,7,8,9]
...
// const digits = [2,4,5,6,7,8,9]
// digits.map(num => console.log(num * 100))

// const digits = [2,4,5,6,7,8,9]
// const africa = ["zambia","gambia","nigeria","bostwanna","ghana"]

// digits.filter((num => console.log(num % 2 == 0)))
// const countryLength = africa.filter((country) => country.length == 5)
// console.log(countryLength)

// const myFemaleFriends = [
//     {name: "Bukky", age: 27},
//     {name: "Rita", age: 25},
//     {name: "Ayomikun", age: 24},
//     {name: "Moradeke", age: 23},
// ]
// const theirAge = myFemaleFriends.filter((age) => age.age > 24)
...
// myFemaleFriends.sort((a,b) => {
// if(a.age < b.age ) return -1
// if(a.age > b.age ) return 1
// return 0
// })
// console.log(myFemaleFriends)

// ========================================\

// const femaleFriends = new Set()

// femaleFriends.add('asake') 
// femaleFriends.add('renike') 
// femaleFriends.add('radeke') 
// femaleFriends.add('foluke') 
// femaleFriends.add('bimbo') 


// console.log(femaleFriends)
// console.log(femaleFriends.size)
// console.log(femaleFriends.delete('bimbo'))
// console.log(femaleFriends)
...
// let check = c.filter((num) => num % 2 == 0)
// let d = new Set(check)
// console.log(d)
